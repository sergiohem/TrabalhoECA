...
$lista = $object->listarActionsPorCodigo("s");

$teste = new action(0,"t","aasd");

$pdf->SetCreator(PDF_CREATOR);
$pdf->SetAuthor('Tassio Sirqueira');
$pdf->SetTitle('TCPDF Exemplo');
$pdf->SetSubject('TCPDF Aula');
$pdf->SetKeywords('TCPDF, PDF, exemplo');
